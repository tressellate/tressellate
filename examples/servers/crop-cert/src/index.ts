...
const config: CropCertConfig = {
	network: (process.env.HEDERA_NETWORK as CropCertConfig['network']) ?? 'testnet',
	...
	cropCertCollectionId: process.env.HEDERA_CROP_CERT_COLLECTION_ID,
	cropCertAuditTopicId: process.env.HEDERA_CROP_CERT_AUDIT_TOPIC_ID,
	mirrorNodeUrl: process.env.HEDERA_MIRROR_NODE_URL
};

const server = new Server(
	{ name: 'Hedera Crop Cert MCP', version: '1.0.0' },
	{ capabilities: { tools: {} } }
);
